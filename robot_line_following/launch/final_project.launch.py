...
def generate_launch_description():
    ...
    package_description = "robot_line_following"
    ...
    declare_world_arg = DeclareLaunchArgument("world",
                                              default_value=["--render-engine ogre ", world_file_path],
                                              description="SDF World File") # Laser scan does not work correctly due to render issues here
    ...
    declare_spawn_x = DeclareLaunchArgument("x", default_value="-0.5",
    ...
    # Line Following Program - start with ros2 run
    # robot_line_following = Node(
    #     package="robot_line_following",
    #     executable="robot_line_following",
    #     name="robot_line_following",
    #     output="screen",
    #     emulate_tty=True
    # )
